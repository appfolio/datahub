...
import PrefixedSelect from '../Dataset/Stats/historical/shared/PrefixedSelect';
import { LOOKBACK_WINDOWS } from '../Dataset/Stats/lookbackWindows';
import { getResultColor, getResultIcon, getResultText } from './assertionUtils';
import { BooleanTimeline } from './BooleanTimeline';
import { AssertionResultDetails } from './AssertionResultDetails';
...
export const AssertionDetails = ({ urn, lastEvaluatedAtMillis }: Props) => {
                        ...
                        <>
                            {result && (
                                <AssertionResultDetailsContainer>
                                    <AssertionResultDetails result={result} />
                                </AssertionResultDetailsContainer>
                            )}
                            <div>
